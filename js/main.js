...
const i18nData = {
  ko: {
    ...
    'nav.tourism': '관광안내',
    'nav.contact': '무료 상담',
    'hero.badge': '일본 재생의료 상담 컨시어지',
    'hero.title': '당신의 건강 여정,<br /><span class="hero-highlight">처음부터 끝까지</span><br />함께합니다',
    'hero.sub': '자택 픽업부터 일본 현지 병원 방문, 통역, 호텔, 귀국 후 안내까지<br />치료 여정의 불편함을 줄이는 <strong>프리미엄 의료 컨시어지</strong>',
    'hero.cta1': '상담 가능 여부 문의',
    'hero.cta2': '이용방법 보기',
  ...
  ja: {
    ...
    'nav.tourism': '観光案内',
    'nav.contact': '無料相談',
    'hero.badge': '日本再生医療相談コンシェルジュ',
    'hero.title': 'あなたの健康の旅を、<br /><span class="hero-highlight">最初から最後まで</span><br />ご一緒します',
    'hero.sub': 'ご自宅から日本現地の医療機関訪問、通訳、ホテル、帰国後のご案内まで<br />治療相談の不安を減らす<strong>プレミアム医療コンシェルジュ</strong>',
    'hero.cta1': '相談可能範囲を確認',
    'hero.cta2': 'ご利用方法を見る',
  ...
  en: {
    ...
    'hero.badge': 'Japan Regenerative Medicine Consultation Concierge',
    'hero.title': 'Your Health Journey,<br /><span class="hero-highlight">From Start to Finish</span><br />We\'re With You',
    'hero.sub': 'From home pickup to visits with medical institutions in Japan, interpretation, hotels, and post-return guidance.<br />A <strong>premium medical concierge</strong> that reduces friction in your treatment journey.',
    'hero.cta1': 'Check Consultation Fit',
